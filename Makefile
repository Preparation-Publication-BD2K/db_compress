...
model_exec : model.o model_impl.o attribute.o data_io.o model_test.cpp
	g++ -std=c++11 -Wall model.o model_impl.o attribute.o data_io.o model_test.cpp -o model_test
